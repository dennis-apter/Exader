...
#else
				throw new ArgumentOutOfRangeException("index", index, "Позиция вставки превышает длину массива.");
#endif
			}
...
#else
				throw new ArgumentOutOfRangeException("index", index, "Позиция удаления превышает длину массива.");
#endif
			}
